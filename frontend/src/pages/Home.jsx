                    ...
                    <div className='mx-auto w-11/12 max-w-maxContent flex flex-col items-center justify-between gap-7'>
                        <div className='flex flex-col lg:flex-row gap-5 mb-10 mt-[95px]'>
                            ...
                            <div className='flex flex-col gap-10 w-full lg:w-[40%] items-start'>
                                ...
                                Today’s IT industry demands more than just technical skills. Our platform equips learners with practical knowledge, problem-solving abilities, and industry-ready expertise to become competitive professionals.
                                </div>
                                <CTAButton active={true} linkto={"/signup"}>
                                    <div>
                                        Learn more
